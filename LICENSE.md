...
associated source code (the "Software") to view and read the source code
for personal, educational, and evaluation purposes only.
...
any person to:
  ...
  a. Copy, reproduce, or distribute the Software or any portion of it,
     in source or compiled form;
  b. Modify, adapt, translate, or create derivative works based on the
     Software;
  c. Publish, republish, sublicense, rehost, or otherwise make the
     Software (in whole or in part) available to any third party, under
     this name or any other name;
  d. Represent, imply, or claim authorship or ownership of the Software
     or any derivative of it;
  e. Use the Software, in whole or in part, to provide a competing
     product or service, whether free or commercial;
  f. Remove or alter any copyright, trademark, or other proprietary
